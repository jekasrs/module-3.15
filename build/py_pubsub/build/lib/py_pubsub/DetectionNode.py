...
class DetectionNode(Node):
    ...
    def imageRectifiedCallback(self, msg):
        # self.get_logger().info("[INFO]: rectified image received from Package\tSize: %dx%d - Timestamp: %u.%u sec ", msg.width, msg.height, msg.header.stamp.sec, msg.header.stamp.nanosec)
        ...
        if len(corners) != 0:
        	...
        	self.i += 1
                # str_info = f"[DETECTION]: vectors are: r={rvec_arr}, v={tvec_arr}"
